...
const MESSAGE = "If you're playing on mobile, put your device into landscape mode!"
...
function addItem() {
    ...
    if (possibleItems.length > 12) {
        ...
        image.style.top = topShelfHeight + Math.floor(Math.random() * (bottomShelfHeight - (el.height / 2))) + "px";
        //image.style.top = topShelfHeight + Math.floor(Math.random() * (bottomShelfHeight - IMAGE-HEIGHT)) + "px";
